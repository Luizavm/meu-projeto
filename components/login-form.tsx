            ...
            <FieldGroup className="space-y-5">
              ...
              <Field>
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    className="text-sm font-medium text-blue-600 hover:text-blue-700 hover:underline underline-offset-4 transition-colors"
                  >
              ...
              <Field className="space-y-3 pt-2">
                ...
                <Button 
                  variant="outline" 
                  type="button"
                  className="w-full h-11 border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 font-medium transition-all duration-200"
                >
